...
## Задание
Напишите функцию (имя придумайте сами), которая принимает 3 параметра: 2 числа типа данных `float` и одно число типа данных `unsinged int`. Если 3-й параметр равен 1: найти сумму первых двух параметров, если 2: найти разницу, если 3 - произведение, если 4 - частное.

Написать несколько вариантов применения данной ф-ции.
