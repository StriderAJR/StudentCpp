...
namespace Cycles
{
     ...
     * Этот цикл вначале (перед каждой итерацией) делает проверку условия,
     * а после выполняет код в теле цикла.
     ...
     * наиболее точным - начала выполняет код, а уже после выполняет
     ...
     * Выглядит цикл так:
     *
     * for (объявляем_переменные_счетчика; условие; действие_после_итерации) { тело_цикла }
     *
     * Если что, на всякий случай, итерация - один проход цикла от начала до конца.
